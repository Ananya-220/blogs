...
<aside class="sidebar"> 
    ...
    <nav class="sidebar-nav">
        ...
        <a href="http://localhost/blogs/categories.php" class="nav-item <?php echo ($pagename == "Categories" || $pagename == "Create Category" || $pagename == "Edit Category" || $pagename == "Delete Category") ? 'active' : "";?>">
            <span class="nav-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
